...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'cyber-gradient-active': 'linear-gradient(135deg, #FF3A30 0%, #FF3A30 100%)',
        'cyber-gradient-inactive': 'linear-gradient(135deg, #4A4A4A 0%, #4A4A4A 100%)',
        'cyber-gradient-pending': 'linear-gradient(135deg, #00F0FF 0%, #00F0FF 100%)',
        'cyber-gradient-completed': 'linear-gradient(135deg, #00FF00 0%, #00FF00 100%)',
      },
      animation: {
      ...
      keyframes: {
        glow: {
          ...
          '100%': { boxShadow: '0 0 10px rgba(59, 130, 246, 0.7), 0 0 20px rgba(59, 130, 246, 0.5)' },
        }
      }
    },
  },
