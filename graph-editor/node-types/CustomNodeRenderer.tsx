...
const CustomNodeRenderer = ({ data, selected, isConnectable = true }: CustomNodeRendererProps) => {
  ...
  return (
    <div className={`p-4 rounded-md border shadow-md min-w-40 ${nodeColorClass} ${data.errorClass || ''} ${selected ? 'ring-2 ring-white' : ''}`}>
      <Handle
        type="target"
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Validation status */}
        {validationStatus && (
          <div className={`text-xs flex items-center ${validationStatus.cssClass}`} title="Node has validation issues">
